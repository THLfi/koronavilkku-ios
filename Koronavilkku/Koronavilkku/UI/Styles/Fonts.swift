...
extension UIFont {
    ...
    static var labelSecondary = useFont(name: "SourceSansPro-Bold", ofSize: 14, withStyle: .caption1)
    static var labelTertiary = useFont(name: "SourceSansPro-Regular", ofSize: 14, withStyle: .caption1)
